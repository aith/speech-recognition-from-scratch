# Code from https://github.com/30stomercury/Automatic-Speech-Recognition/blob/master/utils/tokenizer.py
...
class SubwordEncoder:
    ...
    def __init__(self, path='subword/'):
        ...
        # Load vocab
        self.subword_tokenizer = CharBPETokenizer(vocab_file=path + "/bpe-vocab.json",
                                                  merges_file=path + "/bpe-merges.txt")
